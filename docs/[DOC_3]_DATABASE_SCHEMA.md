...
*   NOTE: The `structured_content` column MUST contain a valid v2.0 page schema as generated by the Visual Composition Engine and defined in `[Blueprint] 08a_EDITOR_BLUEPRINT.md`.*
