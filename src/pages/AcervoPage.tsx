...
const AcervoPage = () => {
  ...
  return (
    <div className="min-h-screen">
      <div className="p-6">
        <h1 className="text-3xl font-bold mb-6">Acervo</h1>
        ...
        <ClientSideSorter reviews={acervoData.reviews} selectedTags={selectedTags}>
          {(sortedReviews) => (
            <>
              ...
              <div className="text-center py-4 text-sm text-muted-foreground">
                {selectedTags.length > 0 
                  ? `${sortedReviews.length} reviews encontrados para os filtros selecionados`
